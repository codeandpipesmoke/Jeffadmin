	...
	<div class="headerbar">
        ...
        <div class="headerbar-left">
			<a href="index.html" class="logo">
				<?= $this->Html->image('Jeffadmin./assets/images/logo.png', ['alt' => 'Logo']); ?> <span>Admin</span>
			</a>
        </div>
...
<?php if(isset($user)) { ?>
				<li class="dropdown list-inline-item notif">
					<a class="nav-link dropdown-toggle nav-user" data-bs-toggle="dropdown"  href="#" role="button" aria-haspopup="false" aria-expanded="false">
						<?= $this->Html->image('Jeffadmin./assets/images/avatars/admin.png', ['alt' => 'Profile image', 'class' => 'avatar-rounded']); ?>
					</a>
