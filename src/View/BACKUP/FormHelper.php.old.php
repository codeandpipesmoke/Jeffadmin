...
class FormHelper extends CoreFormHelper
{
    ...
    protected array $_templates = [
		...
		//'datetimeContainer' =>
        //    '<div{{containerAttrs}} ' .
        //        'class="{{containerClass}}form-group {{type}}{{required}}">{{content}}CCC{{help}}</div>',
        //'datetimeContainerError' =>
        //    '<div{{containerAttrs}} ' .
        //        'class="{{containerClass}}form-group {{formGroupPosition}}{{type}}{{required}} is-invalid">' .
        //            '{{content}}BBB{{error}}{{help}}</div>',
        //'datetimeLabel' => '<label{{attrs}}>{{text}}{{tooltip}}AAA</label>',
    ...
    protected array $_templateSet = [
		...
		*/
        'horizontal' => [			
            ...
            'inputContainerError' => '
											<div{{containerAttrs}} class="{{containerClass}}form-group row {{formGroupPosition}}{{type}}{{required}} is-invalid">
												{{content}}
											</div>',
			...
			// DateTime input
            'dateContainer' => '
											<div{{containerAttrs}} class="{{containerClass}}row{{required}}">
												{{content}}
											</div>
								',
            'dateContainerError' =>'
											<div{{containerAttrs}} class="{{containerClass}}row{{required}} is-invalid">
												{{content}}
											</div>
								',
            'dateLabel' => '<label{{attrs}}>{{text}}{{tooltip}}:</label>',
            'dateFormGroup' => '{{label}}
												<div class="col-xs-12 col-sm-12 col-md-4 col-xl-3 col-xxl-3">
													<div class="form-group">
														{{input}}{{error}}{{help}}
													</div>
												</div>',
			'dateInput' => '<div class="input-group {{name}}" id="{{name}}" data-target-input="nearest">
															<input id="{{name}}" name="{{name}}" type="text" class="form-control datetimepicker-input" data-target="#{{name}}">
															<div class="input-group-append" data-target="#{{name}}" data-toggle="{{name}}">
            ...
            'timeContainerError' =>'
								...
								',
            'timeLabel' => '<label{{attrs}}>{{text}}{{tooltip}}:</label>',
            'timeFormGroup' => '{{label}}
												<div class="col-xs-12 col-sm-12 col-md-4 col-xl-3 col-xxl-3">
													<div class="form-group">
														{{input}}{{error}}{{help}}
			...
			'timeInput' => '<div class="input-group {{name}}" id="{{name}}" data-target-input="nearest">
															<input id="{{name}}" name="{{name}}" type="text" class="form-control datetimepicker-input" data-target="#{{name}}">
															<div class="input-group-append" data-target="#{{name}}" data-toggle="{{name}}">
            ...
            'dateTimeContainerError' =>'
								...
								',
            'dateTimeLabel' => '<label{{attrs}}>{{text}}{{tooltip}}:</label>',
            'dateTimeFormGroup' => '{{label}}
												<div class="col-xs-12 col-sm-12 col-md-5 col-xl-4 col-xxl-3">
													<div class="form-group">
														{{input}}{{error}}{{help}}
													</div>
												</div>',
			'dateTimeInput' => '<div class="input-group {{name}}" id="{{name}}" data-target-input="nearest">
															<input id="{{name}}" name="{{name}}" type="text" class="form-control datetimepicker-input" data-target="#{{name}}">
															<div class="input-group-append" data-target="#{{name}}" data-toggle="{{name}}">
																<div class="input-group-text"><i class="fa fa-calendar"></i></div>
															</div>
...
/*
			...
			'dateInput' => '<input type="{{type}}" name="{{name}}"{{attrs}}>',		
			...
			'timeInput' => '<input type="{{type}}" name="{{name}}"{{attrs}}>',		
			...
			'dateTimeInput' => '<input type="{{type}}" name="{{name}}"{{attrs}}>',		
*/
/*
			##################################################################################################################################################
			##################################################################################################################################################
...
/*
			// Select input: OK
            'selectContainer' => '
											<div{{containerAttrs}} class="mb-3 form-group row select {{containerClass}} {{type}}{{required}}">
												{{content}}
											</div>
								',
					
            'selectContainerError' => '
											<div{{containerAttrs}} class="mb-3 form-group row select {{containerClass}} {{type}}{{required}} is-invalid">
												{{content}}
											</div>
											',
						
            'selectLabel' =>'<label{{attrs}}>{{text}}{{tooltip}}:</label>',
            'selectFormGroup' =>'{{label}}
												<div class="col-md-4">
													{{input}}{{error}}{{help}}
												</div>',
//			'selectInput' => '<select class="form-control select2 xxx" id="{{name}}" name="state">
//													{{content}}{{error}}{{help}}
//												</select>',
            'select' => '<select name="{{name}}" class="form-control xxx"{{attrs}}>
														{{content}}
													</select>',

            'multiSelectContainer' => '
											<div{{containerAttrs}} class="mb-3 form-group row select {{containerClass}} {{type}}{{required}}" multiple="multiple">
												{{content}}
											</div>
											',
					
            'multiSelectContainerError' => '
											<div{{containerAttrs}} class="mb-3 form-group row select {{containerClass}} {{type}}{{required}} is-invalid" multiple="multiple">
												{{content}}
											</div>',
            'multiSelectFormGroup' =>'{{label}}
												<div class="col-md-9">
													{{input}}{{error}}{{help}}
												</div>',

			//'multiSelectInput' => '<select class="form-control select2 yyy" id="{{name}}" name="state" multiple="multiple">
			//										{{content}}{{error}}{{help}}
			//									</select>',

            'selectMultiple' => '<select name="{{name}}[]" class="form-control select2 yyy" multiple="multiple"{{attrs}}>
														{{content}}
													</select>',
*/
...
/*
			// Select input: OK
            'select2Container' => '
											<div{{containerAttrs}} class="{{containerClass}}form-group row {{type}}{{required}}">												{{content}}
											</div>
								',
					
            'select2ContainerError' => '
											<div{{containerAttrs}} class="{{containerClass}}form-group row {{formGroupPosition}}{{type}}{{required}} is-invalid">
												{{content}}
											</div>',
						
            'select2Label' =>'<label{{attrs}}>{{text}}{{tooltip}}:</label>',
            'select2FormGroup' =>'
												{{label}}
												<div class="col-md-4">
													{{input}}{{error}}{{help}}
            ...
            'multiSelect2Container' => '
											<div{{containerAttrs}} class="{{containerClass}}form-group row {{type}}{{required}}">												{{content}}
											</div>
											',
					
            'multiSelect2ContainerError' => '
											<div{{containerAttrs}} class="{{containerClass}}form-group row {{formGroupPosition}}{{type}}{{required}} is-invalid">
												{{content}}
											</div>',
            'multiSelect2FormGroup' =>'
												{{label}}
												<div class="col-md-9">
													{{input}}{{error}}{{help}}
												</div>',
...
*/
            ...
            'numberContainer' => '
											...
											',
            'numberContainerError' => '
											<div{{containerAttrs}} class="{{containerClass}}form-group row {{formGroupPosition}}{{type}}{{required}} is-invalid">
												{{content}}
											</div>
											',
            'numberFormGroup' => '{{label}}
												<div class="col-md-5 col-xl-4 col-lg-4">
													{{input}}{{error}}{{help}}
												</div>',
            'numberLabel' => '<label{{attrs}}>{{text}}{{tooltip}}:</label>',
			'numberInput' => '<input type="{{type}}" name="{{name}}"{{attrs}}>',		


			// Textarea input
            'textareaContainer' => '<div{{containerAttrs}} class="{{containerClass}}form-group row {{type}}{{required}}">
														{{content}}
													</div>',
            'textareaContainerError' => '<div{{containerAttrs}} class="{{containerClass}}form-group row {{formGroupPosition}}{{type}}{{required}} is-invalid">
														{{content}}
													</div>',
            'textareaFormGroup' => '{{label}}
														<div class="col-md-12">
															{{input}}{{error}}{{help}}
														</div>',
            'textareaLabel' => '<label{{attrs}}>{{text}}{{tooltip}}:</label>',
			'textareaInput' => '<textarea name="{{name}}"{{attrs}}>{{value}}</textarea>',
            ...
            'switchContainer' => '
											<div{{containerAttrs}} class="{{containerClass}}form-group row {{type}}{{required}}">{{content}}
												...
												',
            'switchContainerError' => '<div{{containerAttrs}} class="{{containerClass}}form-group row {{formGroupPosition}}{{type}}{{required}} is-invalid">
													{{content}}
												</div>
												',											
            'switchFormGroup' => '
												...
												<div class="col-sm-10">
													<div class="form-check form-switch{{variant}}">
														{{input}}{{label}}
													</div>
												</div>',
			'switchLabel' => '<label class="form-check-label"{{attrs}}>{{text}}{{tooltip}}:</label>',
			'switchInput' => '<input type="{{type}}" name="{{name}}"{{attrs}} />',
            'checkboxFormGroup' => '
											<label for="hidden" class="col-sm-2 col-form-label text-start text-sm-end"></label>
											<div class="col-sm-10">
												<div class="form-check form-switch{{variant}}">
