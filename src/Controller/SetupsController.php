...
//namespace Jeffadmin\Controller\Admin;
namespace Jeffadmin\Controller;

use Jeffadmin\Controller\AppController;
...
class SetupsController extends AppController
{
    ...
    public function index($clearFilter = null)
    {
		...
		if($identity->is_superuser !== true){
			$this->Flash->warning(__('You do not have permission to perform this operation!'), ['plugin' => 'Jeffadmin']);
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Setups->save($setup)) {
                //$this->Flash->success(__('The setup has been saved.'), ['plugin' => 'Jeffadmin']);
            ...
            //$this->Flash->error(__('The setup could not be saved. Please, try again.'), ['plugin' => 'Jeffadmin']);
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Setups->delete($setup)) {
            ...
            //$this->Flash->success(__('The setup has been deleted.'), ['plugin' => 'Jeffadmin']);
            $this->Flash->success(__('The has been deleted.'), ['plugin' => 'Jeffadmin']);
        } else {
            //$this->Flash->error(__('The setup could not be deleted. Please, try again.'), ['plugin' => 'Jeffadmin']);
